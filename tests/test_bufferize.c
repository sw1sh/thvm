...
int main(void) {
  ...
  TEST_BEGIN("kernel-output-accessors/single-output-kernel");
  // Every emitted kernel reports output_count == 1 and the slot-0
  // accessors return the legacy output_tid family; other slots
  // return 0 / sentinels.
  setenv("THVM_UOP_GRAPH_SIMPLIFY", "0", 1);
