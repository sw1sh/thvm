ProofObject["EquationalLogic", Inactive[Equal][
  a \[CircleTimes] (b \[CircleTimes] c), (a \[CircleTimes] b) \[CircleTimes] 
   c], {Inactive[Equal][(((a_) \[CircleTimes] (b_)) \[CircleTimes] 
  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"SubstitutionLemma", 7} -> 
     ...
     <|"Statement" -> HoldForm[(a \[CircleTimes] OverBar[b]) \[CircleTimes] 
          OverBar[c] == OverBar[(OverBar[a] \[CircleTimes] b) \[CircleTimes] 
           c]], "Proof" -> <|"Construct" -> {"CriticalPairLemma", 12}, 
        "Orientation" -> -1, "Rule" -> OverBar[OverBar[a_] \[CircleTimes] 
            (b_)] -> a \[CircleTimes] OverBar[b], "Side" -> 1, 
        "Subpattern" -> OverBar[a_], "MatchingConstruct" -> 
         {"SubstitutionLemma", 3}, "MatchingOrientation" -> 1, 
        "MatchingRule" -> OverBar[(a_) \[CircleTimes] OverBar[b_]] -> 
          OverBar[a] \[CircleTimes] b, "MatchingSide" -> 1, 
        "Position" -> {1, 1}|>|>, {"CriticalPairLemma", 15} -> 
     <|"Statement" -> HoldForm[
     ...
     <|"Statement" -> HoldForm[(OverBar[b] \[CircleTimes] a) \[CircleTimes] 
          b == a], "Proof" -> <|"Input" -> {"SubstitutionLemma", 9}, 
    ...
    {"CriticalPairLemma", 17} -> 
     <|"Statement" -> HoldForm[(b \[CircleTimes] OverBar[a]) \[CircleTimes] 
        ...
        "Orientation" -> -1, "Rule" -> 
         OverBar[(OverBar[a_] \[CircleTimes] (b_)) \[CircleTimes] (c_)] -> 
        ...
        "Position" -> {1, 1}|>|>, {"CriticalPairLemma", 18} -> 
     <|"Statement" -> HoldForm[OverBar[a] \[CircleTimes] OverBar[b] == 
         OverBar[a \[CircleTimes] b]], "Proof" -> 
       <|"Construct" -> {"SubstitutionLemma", 3}, "Orientation" -> 1, 
        "Rule" -> OverBar[(a_) \[CircleTimes] OverBar[b_]] -> 
        ...
        "Position" -> {1, 2}|>|>, {"CriticalPairLemma", 19} -> 
     <|"Statement" -> HoldForm[
     ...
     <|"Statement" -> HoldForm[(b \[CircleTimes] OverBar[a]) \[CircleTimes] 
          OverBar[c] == (OverBar[a] \[CircleTimes] b) \[CircleTimes] 
          OverBar[c]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 17}, 
        "Construct" -> {"CriticalPairLemma", 19}, "Position" -> {}, 
        "Rule" -> OverBar[((a_) \[CircleTimes] OverBar[b_]) \[CircleTimes] 
            (c_)] -> (OverBar[a] \[CircleTimes] b) \[CircleTimes] OverBar[c], 
        "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2, "OutputExpression" -> HoldForm[
          (b \[CircleTimes] OverBar[a]) \[CircleTimes] OverBar[c] == 
           (OverBar[a] \[CircleTimes] b) \[CircleTimes] OverBar[c]], 
        "Source" -> "cpl"|>|>, {"SubstitutionLemma", 12} -> 
     <|"Statement" -> HoldForm[(b \[CircleTimes] OverBar[a]) \[CircleTimes] 
          OverBar[c] == b \[CircleTimes] (OverBar[a] \[CircleTimes] 
           OverBar[c])], "Proof" -> <|"Input" -> {"SubstitutionLemma", 11}, 
     ...
     <|"Statement" -> HoldForm[(b \[CircleTimes] OverBar[a]) \[CircleTimes] 
          OverBar[c] == b \[CircleTimes] OverBar[a \[CircleTimes] c]], 
     ...
     <|"Statement" -> HoldForm[OverBar[a] \[CircleTimes] (b \[CircleTimes] 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 13}, 
        ...
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1, 
        "OutputExpression" -> HoldForm[OverBar[a] \[CircleTimes] 
            (b \[CircleTimes] OverBar[c]) == b \[CircleTimes] 
            OverBar[a \[CircleTimes] c]], "Source" -> "cpl"|>|>, 
    {"CriticalPairLemma", 20} -> 
     <|"Statement" -> HoldForm[OverBar[a \[CircleTimes] (b \[CircleTimes] 
            OverBar[c])] == OverBar[a] \[CircleTimes] 
          (OverBar[b] \[CircleTimes] c)], "Proof" -> 
       <|"Construct" -> {"CriticalPairLemma", 18}, "Orientation" -> 1, 
        ...
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         OverBar[(a_) \[CircleTimes] OverBar[b_]] -> 
          OverBar[a] \[CircleTimes] b, "MatchingSide" -> 1, 
        "Position" -> {2}|>|>, {"CriticalPairLemma", 21} -> 
     <|"Statement" -> HoldForm[OverBar[a] \[CircleTimes] 
          (OverBar[c] \[CircleTimes] b) == OverBar[a \[CircleTimes] 
           (OverBar[b] \[CircleTimes] c)]], "Proof" -> 
       <|"Construct" -> {"CriticalPairLemma", 20}, "Orientation" -> 1, 
        "Rule" -> OverBar[(a_) \[CircleTimes] ((b_) \[CircleTimes] 
             OverBar[c_])] -> OverBar[a] \[CircleTimes] 
           (OverBar[b] \[CircleTimes] c), "Side" -> 1, 
        "Subpattern" -> (b_) \[CircleTimes] OverBar[c_], 
        "MatchingConstruct" -> {"CriticalPairLemma", 16}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (a_) \[CircleTimes] (b_) -> b \[CircleTimes] a, "MatchingSide" -> 1, 
        "Position" -> {1, 2}|>|>, {"CriticalPairLemma", 22} -> 
     <|"Statement" -> HoldForm[OverBar[a] \[CircleTimes] (b \[CircleTimes] 
           OverBar[c]) == OverBar[a \[CircleTimes] (OverBar[b] \[CircleTimes] 
     ...
     <|"Statement" -> HoldForm[OverBar[c \[CircleTimes] a] \[CircleTimes] 
          b == OverBar[a] \[CircleTimes] (b \[CircleTimes] OverBar[c])], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 15}, 
        "Construct" -> {"CriticalPairLemma", 23}, "Position" -> {}, 
        "Rule" -> OverBar[a_] \[CircleTimes] (OverBar[b_] \[CircleTimes] 
            (c_)) -> OverBar[b \[CircleTimes] a] \[CircleTimes] c, 
        "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1, "OutputExpression" -> HoldForm[
          OverBar[c \[CircleTimes] a] \[CircleTimes] b == 
           OverBar[a] \[CircleTimes] (b \[CircleTimes] OverBar[c])], 
        "Source" -> "cpl"|>|>, {"SubstitutionLemma", 17} -> 
     <|"Statement" -> HoldForm[OverBar[c \[CircleTimes] a] \[CircleTimes] 
          b == b \[CircleTimes] OverBar[a \[CircleTimes] c]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 14}, 
        "Construct" -> {"SubstitutionLemma", 16}, "Position" -> {}, 
        "Rule" -> OverBar[a_] \[CircleTimes] ((b_) \[CircleTimes] 
            OverBar[c_]) -> OverBar[c \[CircleTimes] a] \[CircleTimes] b, 
        "Orientation" -> -1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1, "OutputExpression" -> HoldForm[
          OverBar[c \[CircleTimes] a] \[CircleTimes] b == b \[CircleTimes] 
            OverBar[a \[CircleTimes] c]], "Source" -> "cpl"|>|>, 
    {"CriticalPairLemma", 24} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[c] \[CircleTimes] 
            OverBar[b]] \[CircleTimes] a == a \[CircleTimes] 
          OverBar[OverBar[b \[CircleTimes] c]]], 
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 17}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] 
           OverBar[(b_) \[CircleTimes] (c_)] -> 
          OverBar[c \[CircleTimes] b] \[CircleTimes] a, "Side" -> 1, 
        "Subpattern" -> (b_) \[CircleTimes] (c_), "MatchingConstruct" -> 
         {"CriticalPairLemma", 18}, "MatchingOrientation" -> 1, 
        "MatchingRule" -> OverBar[a_] \[CircleTimes] OverBar[b_] -> 
          OverBar[a \[CircleTimes] b], "MatchingSide" -> 1, 
     ...
     <|"Statement" -> HoldForm[OverBar[OverBar[c] \[CircleTimes] 
       ...
       <|"Input" -> {"CriticalPairLemma", 24}, "Construct" -> 
        ...
        "Rule" -> OverBar[OverBar[a_]] -> a, "Orientation" -> -1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[OverBar[OverBar[c] \[CircleTimes] 
              OverBar[b]] \[CircleTimes] a == a \[CircleTimes] 
            (b \[CircleTimes] c)], "Source" -> "cpl"|>|>, 
    {"SubstitutionLemma", 19} -> 
     <|"Statement" -> HoldForm[(OverBar[OverBar[c]] \[CircleTimes] 
           b) \[CircleTimes] a == a \[CircleTimes] (b \[CircleTimes] c)], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 18}, 
        ...
        "OutputExpression" -> HoldForm[(OverBar[OverBar[c]] \[CircleTimes] 
             b) \[CircleTimes] a == a \[CircleTimes] (b \[CircleTimes] c)], 
        "Source" -> "cpl"|>|>, {"SubstitutionLemma", 20} -> 
     <|"Statement" -> HoldForm[(c \[CircleTimes] b) \[CircleTimes] a == 
         a \[CircleTimes] (b \[CircleTimes] c)], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 19}, 
        "Construct" -> {"SubstitutionLemma", 2}, "Position" -> {1, 1}, 
        "Rule" -> OverBar[OverBar[a_]] -> a, "Orientation" -> -1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1, 
        "OutputExpression" -> HoldForm[(c \[CircleTimes] b) \[CircleTimes] 
            a == a \[CircleTimes] (b \[CircleTimes] c)], 
        "Source" -> "cpl"|>|>, {"SubstitutionLemma", 21} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] (c \[CircleTimes] a) == 
         a \[CircleTimes] (b \[CircleTimes] c)], 
     ...
     <|"Statement" -> HoldForm[a \[CircleTimes] (b \[CircleTimes] c) == 
      ...
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Construct" -> 
         {"SubstitutionLemma", 7}, "Position" -> {}, 
        "Rule" -> ((a_) \[CircleTimes] (b_)) \[CircleTimes] (c_) -> 
          b \[CircleTimes] (a \[CircleTimes] c), "Orientation" -> 1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[a \[CircleTimes] (b \[CircleTimes] 
             c) == b \[CircleTimes] (a \[CircleTimes] c)], 
     ...
     <|"Statement" -> HoldForm[a \[CircleTimes] (b \[CircleTimes] c) == 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 8}, 
        ...
        "Rule" -> (a_) \[CircleTimes] ((b_) \[CircleTimes] (c_)) -> 
          b \[CircleTimes] (c \[CircleTimes] a), "Orientation" -> -1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[a \[CircleTimes] (b \[CircleTimes] 
     ...
     <|"Statement" -> HoldForm[a \[CircleTimes] (b \[CircleTimes] c) == 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 22}, 
        "Construct" -> {"CriticalPairLemma", 16}, "Position" -> {2}, 
