{ProofObject["EquationalLogic", Inactive[Equal][a \[CirclePlus] b, 
   b \[CirclePlus] a], {Inactive[Equal][(a_) \[CirclePlus] 
     ((b_) \[CirclePlus] (c_)), ((a_) \[CirclePlus] (b_)) \[CirclePlus] 
     (c_)], Inactive[Equal][(a_) \[CirclePlus] (b_), 
    (b_) \[CirclePlus] (a_)], Inactive[Equal][
   ...
   "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
     ...
     {"Conclusion", 1} -> <|"Statement" -> HoldForm[
         ...
         "OutputExpression" -> HoldForm[a \[CirclePlus] (b \[CirclePlus] 
              c) == a \[CirclePlus] (b \[CirclePlus] c)], 
         "Source" -> "synth"|>|>}|>], ProofObject["EquationalLogic", 
  Inactive[Equal][OverBar[OverBar[a \[CirclePlus] b] \[CirclePlus] 
  ...
  <|"Variables" -> {a, b, c, x3}, "Constants" -> {}, 
   "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
     ...
     {"CriticalPairLemma", 1} -> <|"Statement" -> 
        HoldForm[b == OverBar[a \[CirclePlus] OverBar[b]] \[CirclePlus] 
           OverBar[OverBar[b] \[CirclePlus] OverBar[a]]], 
     ...
     {"CriticalPairLemma", 2} -> <|"Statement" -> 
        HoldForm[a == OverBar[OverBar[a] \[CirclePlus] b] \[CirclePlus] 
           OverBar[OverBar[b] \[CirclePlus] OverBar[a]]], 
       "Proof" -> <|"Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
         "Rule" -> OverBar[OverBar[a_] \[CirclePlus] (b_)] \[CirclePlus] 
            OverBar[OverBar[a_] \[CirclePlus] OverBar[b_]] -> a, "Side" -> 1, 
      ...
      <|"Statement" -> HoldForm[b \[CirclePlus] (a \[CirclePlus] c) == 
       ...
       "Proof" -> <|"Input" -> {"CriticalPairLemma", 4}, 
         ...
         "Rule" -> ((a_) \[CirclePlus] (b_)) \[CirclePlus] (c_) -> 
           a \[CirclePlus] (b \[CirclePlus] c), "Orientation" -> -1, 
         "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
         "OutputExpression" -> HoldForm[b \[CirclePlus] (a \[CirclePlus] 
              c) == a \[CirclePlus] (b \[CirclePlus] c)], 
     ...
     {"CriticalPairLemma", 6} -> <|"Statement" -> 
        HoldForm[a \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] 
             OverBar[OverBar[b]]] == OverBar[OverBar[a] \[CirclePlus] 
             b] \[CirclePlus] a], "Proof" -> 
     ...
     {"SubstitutionLemma", 5} -> <|"Statement" -> 
        HoldForm[a \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] 
             OverBar[OverBar[b]]] == a \[CirclePlus] 
       ...
       "Proof" -> <|"Input" -> {"CriticalPairLemma", 6}, 
         ...
         "Side" -> 2, "OutputExpression" -> HoldForm[
           a \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] OverBar[
                OverBar[b]]] == a \[CirclePlus] OverBar[OverBar[
                a] \[CirclePlus] b]], "Source" -> "norm"|>|>, 
     {"CriticalPairLemma", 7} -> <|"Statement" -> 
        HoldForm[b \[CirclePlus] (a \[CirclePlus] OverBar[
             OverBar[b] \[CirclePlus] OverBar[OverBar[c]]]) == 
     ...
     {"CriticalPairLemma", 8} -> <|"Statement" -> 
        HoldForm[OverBar[OverBar[OverBar[b]] \[CirclePlus] a] \[CirclePlus] 
           (a \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] b]) == 
     ...
     {"CriticalPairLemma", 9} -> <|"Statement" -> 
        HoldForm[c \[CirclePlus] (a \[CirclePlus] b) == a \[CirclePlus] 
           (b \[CirclePlus] c)], "Proof" -> <|"Construct" -> {"Axiom", 2}, 
         "Orientation" -> 1, "Rule" -> (a_) \[CirclePlus] (b_) -> 
           b \[CirclePlus] a, "Side" -> 1, "Subpattern" -> {}, 
         "MatchingConstruct" -> {"Axiom", 1}, "MatchingOrientation" -> -1, 
         "MatchingRule" -> ((a_) \[CirclePlus] (b_)) \[CirclePlus] (c_) -> 
     ...
     {"CriticalPairLemma", 11} -> <|"Statement" -> 
        HoldForm[OverBar[a] \[CirclePlus] OverBar[OverBar[a]] == 
          OverBar[a] \[CirclePlus] a], "Proof" -> 
        <|"Construct" -> {"SubstitutionLemma", 7}, "Orientation" -> 1, 
         "Rule" -> (a_) \[CirclePlus] (OverBar[OverBar[a_] \[CirclePlus] (
                b_)] \[CirclePlus] OverBar[OverBar[OverBar[b_]] \[CirclePlus] 
               (a_)]) -> a \[CirclePlus] OverBar[b], "Side" -> 1, 
         "Subpattern" -> OverBar[OverBar[a_] \[CirclePlus] 
             (b_)] \[CirclePlus] OverBar[OverBar[OverBar[b_]] \[CirclePlus] 
             (a_)], "MatchingConstruct" -> {"CriticalPairLemma", 10}, 
         "MatchingOrientation" -> -1, "MatchingRule" -> 
          OverBar[(a_) \[CirclePlus] OverBar[b_]] \[CirclePlus] 
     ...
     {"SubstitutionLemma", 8} -> <|"Statement" -> 
        ...
        <|"Input" -> {"CriticalPairLemma", 11}, "Construct" -> {"Axiom", 2}, 
     ...
     {"CriticalPairLemma", 12} -> <|"Statement" -> 
        HoldForm[OverBar[a] \[CirclePlus] (OverBar[OverBar[a]] \[CirclePlus] 
            b) == (a \[CirclePlus] OverBar[a]) \[CirclePlus] b], 
       "Proof" -> <|"Construct" -> {"Axiom", 1}, "Orientation" -> -1, 
         "Rule" -> ((a_) \[CirclePlus] (b_)) \[CirclePlus] (c_) -> 
           a \[CirclePlus] (b \[CirclePlus] c), "Side" -> 1, 
         "Subpattern" -> (a_) \[CirclePlus] (b_), "MatchingConstruct" -> 
     ...
     {"CriticalPairLemma", 13} -> <|"Statement" -> 
        HoldForm[OverBar[a] \[CirclePlus] OverBar[OverBar[OverBar[a]]] == 
          OverBar[a] \[CirclePlus] OverBar[a \[CirclePlus] 
             (OverBar[a] \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] 
                OverBar[OverBar[OverBar[a]]]])]], 
       "Proof" -> <|"Construct" -> {"SubstitutionLemma", 3}, 
         "Orientation" -> -1, "Rule" -> OverBar[a_] \[CirclePlus] 
            OverBar[OverBar[a_] \[CirclePlus] ((b_) \[CirclePlus] OverBar[
                OverBar[a_] \[CirclePlus] OverBar[b_]])] -> 
           OverBar[a] \[CirclePlus] OverBar[b], "Side" -> 1, 
         "Subpattern" -> OverBar[a_] \[CirclePlus] ((b_) \[CirclePlus] 
            OverBar[OverBar[a_] \[CirclePlus] OverBar[b_]]), 
     ...
     {"SubstitutionLemma", 10} -> <|"Statement" -> 
        HoldForm[OverBar[a] \[CirclePlus] OverBar[OverBar[OverBar[a]]] == 
          OverBar[a] \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] 
             (a \[CirclePlus] OverBar[OverBar[a] \[CirclePlus] OverBar[
                 a]])]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 13}, 
     ...
     {"SubstitutionLemma", 11} -> <|"Statement" -> 
       ...
       "Proof" -> <|"Input" -> {"SubstitutionLemma", 10}, 
         ...
         "Rule" -> OverBar[a_] \[CirclePlus] OverBar[
             OverBar[a_] \[CirclePlus] ((b_) \[CirclePlus] OverBar[
                OverBar[a_] \[CirclePlus] OverBar[b_]])] -> 
           OverBar[a] \[CirclePlus] OverBar[b], "Orientation" -> -1, 
         "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
         "OutputExpression" -> HoldForm[OverBar[a] \[CirclePlus] 
     ...
     {"CriticalPairLemma", 14} -> <|"Statement" -> 
        HoldForm[OverBar[OverBar[a]] == OverBar[OverBar[a] \[CirclePlus] 
             OverBar[a]] \[CirclePlus] OverBar[
            OverBar[OverBar[OverBar[a]]] \[CirclePlus] OverBar[OverBar[a]]]], 
       "Proof" -> <|"Construct" -> {"CriticalPairLemma", 1}, 
         "Orientation" -> -1, "Rule" -> 
          OverBar[(a_) \[CirclePlus] OverBar[b_]] \[CirclePlus] 
            OverBar[OverBar[b_] \[CirclePlus] OverBar[a_]] -> b, "Side" -> 1, 
      ...
      <|"Statement" -> HoldForm[OverBar[OverBar[a]] == 
          OverBar[OverBar[a] \[CirclePlus] OverBar[a]] \[CirclePlus] 
           OverBar[OverBar[OverBar[a]] \[CirclePlus] OverBar[OverBar[OverBar[
                a]]]]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 14}, 
         "Construct" -> {"Axiom", 2}, "Position" -> {2, 1}, 
         "Rule" -> (a_) \[CirclePlus] (b_) -> b \[CirclePlus] a, 
         "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
     ...
     {"SubstitutionLemma", 13} -> <|"Statement" -> 
        ...
        <|"Input" -> {"SubstitutionLemma", 12}, "Construct" -> 
          {"SubstitutionLemma", 8}, "Position" -> {2, 1}, 
      ...
      <|"Statement" -> HoldForm[OverBar[OverBar[a]] == a], 
       "Proof" -> <|"Input" -> {"SubstitutionLemma", 13}, 
         ...
         "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
         "Side" -> 2, "OutputExpression" -> HoldForm[OverBar[OverBar[a]] == 
            a], "Source" -> "norm"|>|>, {"CriticalPairLemma", 15} -> 
      <|"Statement" -> HoldForm[OverBar[a] == 
          OverBar[a \[CirclePlus] b] \[CirclePlus] 
           OverBar[OverBar[OverBar[a]] \[CirclePlus] OverBar[b]]], 
       "Proof" -> <|"Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
         "Rule" -> OverBar[OverBar[a_] \[CirclePlus] (b_)] \[CirclePlus] 
            OverBar[OverBar[a_] \[CirclePlus] OverBar[b_]] -> a, "Side" -> 1, 
         ...
         "Position" -> {1, 1, 1}|>|>, {"SubstitutionLemma", 15} -> 
      <|"Statement" -> HoldForm[OverBar[a] == 
          OverBar[a \[CirclePlus] b] \[CirclePlus] 
           OverBar[a \[CirclePlus] OverBar[b]]], 
       "Proof" -> <|"Input" -> {"CriticalPairLemma", 15}, 
         "Construct" -> {"SubstitutionLemma", 14}, "Position" -> {2, 1, 1}, 
         "Rule" -> OverBar[OverBar[a_]] -> a, "Orientation" -> 1, 
         "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
         "OutputExpression" -> HoldForm[OverBar[a] == 
            OverBar[a \[CirclePlus] b] \[CirclePlus] OverBar[
              a \[CirclePlus] OverBar[b]]], "Source" -> "norm"|>|>, 
     {"SubstitutionLemma", 16} -> <|"Statement" -> 
        HoldForm[OverBar[OverBar[a]] == a], "Proof" -> 
        <|"Input" -> {"Hypothesis", 1}, "Construct" -> {"SubstitutionLemma", 
           15}, "Position" -> {1}, "Rule" -> 
          OverBar[(a_) \[CirclePlus] (b_)] \[CirclePlus] 
            OverBar[(a_) \[CirclePlus] OverBar[b_]] -> OverBar[a], 
         "Orientation" -> -1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
         "Side" -> 1, "OutputExpression" -> HoldForm[OverBar[OverBar[a]] == 
            a], "Source" -> "cpl"|>|>, {"Conclusion", 1} -> 
      <|"Statement" -> HoldForm[a == a], "Proof" -> 
        <|"Input" -> {"SubstitutionLemma", 16}, "Construct" -> 
          {"SubstitutionLemma", 14}, "Position" -> {}, 
         "Rule" -> OverBar[OverBar[a_]] -> a, "Orientation" -> 1, 
         "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1, 
