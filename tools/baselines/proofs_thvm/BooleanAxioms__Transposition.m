  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Axiom", 6} -> <|"Statement" -> HoldForm[
     ...
     <|"Statement" -> HoldForm[OverBar[a] \[CirclePlus] b == 
         OverBar[OverBar[b]] \[CirclePlus] OverBar[a]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] (b \[CirclePlus] 
    ...
    {"SubstitutionLemma", 1} -> 
     ...
     <|"Statement" -> HoldForm[b \[CirclePlus] OverBar[a] == 
       ...
       <|"Input" -> {"SubstitutionLemma", 1}, "Construct" -> 
        ...
        "OutputExpression" -> HoldForm[b \[CirclePlus] OverBar[a] == 
           b \[CirclePlus] OverBar[a]], "Source" -> "cpl"|>|>}|>]
