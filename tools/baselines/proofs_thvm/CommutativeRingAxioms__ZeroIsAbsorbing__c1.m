 ...
 <|"Variables" -> {a, b, c, x3}, "Constants" -> {}, 
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Axiom", 7} -> <|"Statement" -> HoldForm[a \[CircleTimes] b == 
         b \[CircleTimes] a], "Proof" -> <||>|>, {"Hypothesis", 1} -> 
    ...
    {"SubstitutionLemma", 2} -> 
     ...
     <|"Statement" -> HoldForm[b == OverBar[a] \[CirclePlus] 
       ...
       <|"Construct" -> {"SubstitutionLemma", 1}, "Orientation" -> 1, 
        ...
        "Position" -> {2, 1}|>|>, {"CriticalPairLemma", 5} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] c == 
         OverBar[a \[CircleTimes] b] \[CirclePlus] a \[CircleTimes] 
           (b \[CirclePlus] c)], "Proof" -> 
       <|"Construct" -> {"CriticalPairLemma", 4}, "Orientation" -> -1, 
        "Rule" -> OverBar[a_] \[CirclePlus] ((a_) \[CirclePlus] (b_)) -> b, 
    ...
    {"CriticalPairLemma", 6} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
         OverBar[a \[CircleTimes] b] \[CirclePlus] a \[CircleTimes] b], 
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 5}, 
        "Orientation" -> -1, "Rule" -> 
         OverBar[(a_) \[CircleTimes] (b_)] \[CirclePlus] (a_) \[CircleTimes] 
            ((b_) \[CirclePlus] (c_)) -> a \[CircleTimes] c, "Side" -> 1, 
        "Subpattern" -> (b_) \[CirclePlus] (c_), "MatchingConstruct" -> 
         {"Axiom", 3}, "MatchingOrientation" -> 1, "MatchingRule" -> 
         (a_) \[CirclePlus] OverTilde[0] -> a, "MatchingSide" -> 1, 
        "Position" -> {2, 2}|>|>, {"SubstitutionLemma", 3} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
      ...
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 6}, 
        ...
        "Side" -> 2, "OutputExpression" -> HoldForm[
          a \[CircleTimes] OverTilde[0] == a \[CircleTimes] b \[CirclePlus] 
            OverBar[a \[CircleTimes] b]], "Source" -> "norm"|>|>, 
    {"SubstitutionLemma", 4} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
         OverTilde[0]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 3}, 
        "Construct" -> {"Axiom", 4}, "Position" -> {}, 
        "Rule" -> (a_) \[CirclePlus] OverBar[a_] -> OverTilde[0], 
        "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2, "OutputExpression" -> HoldForm[
          a \[CircleTimes] OverTilde[0] == OverTilde[0]], 
        "Source" -> "norm"|>|>, {"Conclusion", 1} -> 
     <|"Statement" -> HoldForm[OverTilde[0] == OverTilde[0]], 
