 ...
 <|"Variables" -> {a, b, c, x3, x4}, "Constants" -> {}, 
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"SubstitutionLemma", 4} -> 
     ...
     <|"Statement" -> HoldForm[OverBar[c \[CircleTimes] b] == 
         a \[CircleTimes] b \[CirclePlus] OverBar[
           (c \[CirclePlus] a) \[CircleTimes] b]], 
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 4}, 
        ...
        "Subpattern" -> (b_) \[CirclePlus] (a_), "MatchingConstruct" -> 
         ...
         (a_) \[CircleTimes] (b_) \[CirclePlus] (c_) \[CircleTimes] (b_) -> 
          (a \[CirclePlus] c) \[CircleTimes] b, "MatchingSide" -> 1, 
    ...
    {"CriticalPairLemma", 10} -> 
     <|"Statement" -> HoldForm[OverBar[a \[CircleTimes] OverTilde[0]] == 
         a \[CircleTimes] OverTilde[0] \[CirclePlus] 
          OverBar[a \[CircleTimes] OverTilde[0]]], 
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 7}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] (b_) \[CirclePlus] 
           OverBar[((c_) \[CirclePlus] (a_)) \[CircleTimes] (b_)] -> 
          OverBar[c \[CircleTimes] b], "Side" -> 1, "Subpattern" -> 
         ((c_) \[CirclePlus] (a_)) \[CircleTimes] (b_), 
        "MatchingConstruct" -> {"CriticalPairLemma", 9}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         ((a_) \[CirclePlus] (a_)) \[CircleTimes] OverTilde[0] -> 
          a \[CircleTimes] OverTilde[0], "MatchingSide" -> 1, 
        "Position" -> {2, 1}|>|>, {"SubstitutionLemma", 5} -> 
     <|"Statement" -> HoldForm[OverBar[a \[CircleTimes] OverTilde[0]] == 
         OverTilde[0]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 10}, 
