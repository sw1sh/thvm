   ...
   "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
     ...
     {"Axiom", 4} -> <|"Statement" -> HoldForm[
      ...
      <|"Statement" -> HoldForm[a \[CirclePlus] b \[CircleTimes] c == 
       ...
       "Proof" -> <||>|>, {"Hypothesis", 1} -> 
      <|"Statement" -> HoldForm[OverBar[a \[CircleTimes] b] == 
          OverBar[a] \[CirclePlus] OverBar[b]], "Proof" -> <||>|>, 
     {"CriticalPairLemma", 1} -> <|"Statement" -> 
        HoldForm[a \[CircleTimes] (b \[CirclePlus] OverBar[a]) == 
          a \[CircleTimes] b], "Proof" -> <|"Construct" -> {"Axiom", 2}, 
         "Orientation" -> -1, "Rule" -> 
     ...
     {"CriticalPairLemma", 19} -> <|"Statement" -> 
       ...
       "Proof" -> <|"Construct" -> {"SubstitutionLemma", 8}, 
         "Orientation" -> 1, "Rule" -> (a_) \[CirclePlus] (b_) \[CircleTimes] 
             ((c_) \[CirclePlus] (a_)) -> a \[CirclePlus] b \[CircleTimes] c, 
         "Side" -> 1, "Subpattern" -> (b_) \[CircleTimes] ((c_) \[CirclePlus] 
            (a_)), "MatchingConstruct" -> {"CriticalPairLemma", 5}, 
         "MatchingOrientation" -> 1, "MatchingRule" -> 
          (a_) \[CircleTimes] (OverBar[a_] \[CirclePlus] (b_)) -> 
           a \[CircleTimes] b, "MatchingSide" -> 1, "Position" -> {2}|>|>, 
     {"CriticalPairLemma", 20} -> <|"Statement" -> 
     ...
     {"SubstitutionLemma", 70} -> <|"Statement" -> 
        ...
        <|"Input" -> {"SubstitutionLemma", 66}, "Construct" -> 
         ...
         "OutputExpression" -> HoldForm[OverBar[a \[CirclePlus] 
              OverBar[b]] == OverBar[a] \[CircleTimes] b], 
         "Source" -> "norm"|>|>, {"CriticalPairLemma", 71} -> 
      <|"Statement" -> HoldForm[a \[CirclePlus] OverBar[b] == 
       ...
       "Proof" -> <|"Construct" -> {"SubstitutionLemma", 3}, 
         ...
         "MatchingRule" -> OverBar[(a_) \[CirclePlus] OverBar[b_]] -> 
           OverBar[a] \[CircleTimes] b, "MatchingSide" -> 1, 
      ...
      <|"Statement" -> HoldForm[OverBar[a] \[CirclePlus] OverBar[b] == 
        ...
        <|"Construct" -> {"CriticalPairLemma", 71}, "Orientation" -> -1, 
         "Rule" -> OverBar[OverBar[a_] \[CircleTimes] (b_)] -> 
          ...
          OverBar[a_], "MatchingConstruct" -> {"SubstitutionLemma", 3}, 
         "MatchingOrientation" -> -1, "MatchingRule" -> 
          OverBar[OverBar[a_]] -> a, "MatchingSide" -> 1, 
         "Position" -> {1, 1}|>|>, {"Conclusion", 1} -> 
      <|"Statement" -> HoldForm[OverBar[a \[CircleTimes] b] == 
          OverBar[a \[CircleTimes] b]], "Proof" -> 
        <|"Input" -> {"Hypothesis", 1}, "Construct" -> {"CriticalPairLemma", 
           72}, "Position" -> {}, "Rule" -> OverBar[a_] \[CirclePlus] 
