 ...
 <|"Variables" -> {a, b, c, x3, x4}, "Constants" -> {}, 
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"SubstitutionLemma", 4} -> 
     ...
     <|"Statement" -> HoldForm[(a \[CirclePlus] a) \[CircleTimes] b == 
         a \[CircleTimes] (b \[CirclePlus] b)], 
      "Proof" -> <|"Construct" -> {"Axiom", 7}, "Orientation" -> -1, 
        "Rule" -> (a_) \[CircleTimes] (b_) \[CirclePlus] (c_) \[CircleTimes] 
            (b_) -> (a \[CirclePlus] c) \[CircleTimes] b, "Side" -> 1, 
        "Subpattern" -> {}, "MatchingConstruct" -> {"Axiom", 5}, 
        "MatchingOrientation" -> -1, "MatchingRule" -> 
         (a_) \[CircleTimes] (b_) \[CirclePlus] (a_) \[CircleTimes] (c_) -> 
          a \[CircleTimes] (b \[CirclePlus] c), "MatchingSide" -> 1, 
        "Position" -> {}|>|>, {"CriticalPairLemma", 8} -> 
     <|"Statement" -> HoldForm[(a \[CirclePlus] a) \[CircleTimes] 
          OverTilde[0] == a \[CircleTimes] OverTilde[0]], 
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 7}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] 
           ((b_) \[CirclePlus] (b_)) -> (a \[CirclePlus] a) \[CircleTimes] b, 
        "Side" -> 1, "Subpattern" -> (b_) \[CirclePlus] (b_), 
        "MatchingConstruct" -> {"Axiom", 3}, "MatchingOrientation" -> 1, 
        "MatchingRule" -> (a_) \[CirclePlus] OverTilde[0] -> a, 
        "MatchingSide" -> 1, "Position" -> {2}|>|>, 
    {"CriticalPairLemma", 9} -> 
     <|"Statement" -> HoldForm[((a \[CirclePlus] a) \[CirclePlus] 
           b) \[CircleTimes] OverTilde[0] == 
         a \[CircleTimes] OverTilde[0] \[CirclePlus] b \[CircleTimes] 
           OverTilde[0]], "Proof" -> <|"Construct" -> {"Axiom", 7}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] (b_) \[CirclePlus] 
           (c_) \[CircleTimes] (b_) -> (a \[CirclePlus] c) \[CircleTimes] b, 
        "Side" -> 1, "Subpattern" -> (a_) \[CircleTimes] (b_), 
        "MatchingConstruct" -> {"CriticalPairLemma", 8}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         ((a_) \[CirclePlus] (a_)) \[CircleTimes] OverTilde[0] -> 
          a \[CircleTimes] OverTilde[0], "MatchingSide" -> 1, 
        "Position" -> {1}|>|>, {"SubstitutionLemma", 5} -> 
     <|"Statement" -> HoldForm[((a \[CirclePlus] a) \[CirclePlus] 
           b) \[CircleTimes] OverTilde[0] == 
         (a \[CirclePlus] b) \[CircleTimes] OverTilde[0]], 
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 9}, 
        "Construct" -> {"Axiom", 7}, "Position" -> {}, 
        "Rule" -> (a_) \[CircleTimes] (b_) \[CirclePlus] (c_) \[CircleTimes] 
            (b_) -> (a \[CirclePlus] c) \[CircleTimes] b, 
        "Orientation" -> -1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2, "OutputExpression" -> HoldForm[
          ((a \[CirclePlus] a) \[CirclePlus] b) \[CircleTimes] 
            OverTilde[0] == (a \[CirclePlus] b) \[CircleTimes] OverTilde[0]], 
     ...
     <|"Statement" -> HoldForm[(a \[CirclePlus] (a \[CirclePlus] 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 5}, 
        ...
        "OutputExpression" -> HoldForm[(a \[CirclePlus] (a \[CirclePlus] 
              b)) \[CircleTimes] OverTilde[0] == 
           (a \[CirclePlus] b) \[CircleTimes] OverTilde[0]], 
        "Source" -> "norm"|>|>, {"CriticalPairLemma", 10} -> 
     <|"Statement" -> HoldForm[(a \[CirclePlus] (OverBar[a] \[CirclePlus] 
            b)) \[CircleTimes] OverTilde[0] == 
         (a \[CirclePlus] b) \[CircleTimes] OverTilde[0]], 
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 6}, 
        "Orientation" -> 1, "Rule" -> 
         ((a_) \[CirclePlus] ((a_) \[CirclePlus] (b_))) \[CircleTimes] 
           OverTilde[0] -> (a \[CirclePlus] b) \[CircleTimes] OverTilde[0], 
        "Side" -> 1, "Subpattern" -> (a_) \[CirclePlus] (b_), 
        "MatchingConstruct" -> {"SubstitutionLemma", 1}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (a_) \[CirclePlus] (OverBar[a_] \[CirclePlus] (b_)) -> b, 
        "MatchingSide" -> 1, "Position" -> {1, 2}|>|>, 
    {"SubstitutionLemma", 7} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] OverTilde[0] == 
         (a \[CirclePlus] b) \[CircleTimes] OverTilde[0]], 
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 10}, 
        "Construct" -> {"SubstitutionLemma", 1}, "Position" -> {1}, 
        "Rule" -> (a_) \[CirclePlus] (OverBar[a_] \[CirclePlus] (b_)) -> b, 
        "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1, "OutputExpression" -> HoldForm[
          b \[CircleTimes] OverTilde[0] == (a \[CirclePlus] b) \[CircleTimes] 
    ...
    {"CriticalPairLemma", 11} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
      ...
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 7}, 
        "Orientation" -> -1, "Rule" -> 
         ((a_) \[CirclePlus] (b_)) \[CircleTimes] OverTilde[0] -> 
          b \[CircleTimes] OverTilde[0], "Side" -> 1, 
        "Subpattern" -> (a_) \[CirclePlus] (b_), "MatchingConstruct" -> 
         {"Axiom", 2}, "MatchingOrientation" -> 1, "MatchingRule" -> 
         (a_) \[CirclePlus] (b_) -> b \[CirclePlus] a, "MatchingSide" -> 1, 
        "Position" -> {1}|>|>, {"SubstitutionLemma", 8} -> 
     <|"Statement" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
         b \[CircleTimes] OverTilde[0]], "Proof" -> 
       <|"Input" -> {"CriticalPairLemma", 11}, "Construct" -> 
         {"SubstitutionLemma", 7}, "Position" -> {}, 
        "Rule" -> ((a_) \[CirclePlus] (b_)) \[CircleTimes] OverTilde[0] -> 
          b \[CircleTimes] OverTilde[0], "Orientation" -> -1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[a \[CircleTimes] OverTilde[0] == 
           b \[CircleTimes] OverTilde[0]], "Source" -> "norm"|>|>, 
    {"CriticalPairLemma", 12} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] (OverTilde[0] \[CirclePlus] 
           c) == a \[CircleTimes] OverTilde[0] \[CirclePlus] 
          b \[CircleTimes] c], "Proof" -> <|"Construct" -> {"Axiom", 5}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] (b_) \[CirclePlus] 
           (a_) \[CircleTimes] (c_) -> a \[CircleTimes] (b \[CirclePlus] c), 
        "Side" -> 1, "Subpattern" -> (a_) \[CircleTimes] (b_), 
        "MatchingConstruct" -> {"SubstitutionLemma", 8}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (a_) \[CircleTimes] OverTilde[0] -> b \[CircleTimes] OverTilde[0], 
        "MatchingSide" -> 1, "Position" -> {1}|>|>, 
    {"SubstitutionLemma", 9} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] c == 
         a \[CircleTimes] OverTilde[0] \[CirclePlus] b \[CircleTimes] c], 
    ...
    {"SubstitutionLemma", 11} -> 
     <|"Statement" -> HoldForm[OverTilde[0] == a \[CircleTimes] 
          OverTilde[0]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 14}, 
        "Construct" -> {"Axiom", 3}, "Position" -> {}, 
        "Rule" -> (a_) \[CirclePlus] OverTilde[0] -> a, "Orientation" -> 1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
