ProofObject["EquationalLogic", Inactive[Equal][
  a \[CircleDot] (a \[CircleDot] a), (a \[CircleDot] a) \[CircleDot] 
 ...
 {Inactive[Equal][(a_) \[CircleDot] 
  ...
  "Constants" -> {}, "Proof" -> 
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[
     ...
     <|"Statement" -> HoldForm[a \[CircleDot] (a \[CircleDot] a) == 
    ...
    {"SubstitutionLemma", 22} -> 
     <|"Statement" -> HoldForm[a == (a \[CircleDot] a) \[CircleDot] 
          ((a \[CircleDot] a) \[CircleDot] a)], 
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Construct" -> 
        ...
        "Side" -> 1, "OutputExpression" -> HoldForm[
          a == (a \[CircleDot] a) \[CircleDot] ((a \[CircleDot] 
              a) \[CircleDot] a)], "Source" -> "cpl"|>|>, 
