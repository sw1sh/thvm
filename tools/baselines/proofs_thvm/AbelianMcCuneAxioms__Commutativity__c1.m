ProofObject["EquationalLogic", Inactive[Equal][a \[CircleTimes] b, 
 ...
 <|"Variables" -> {a, b, c, x3}, "Constants" -> {}, 
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Hypothesis", 1} -> <|"Statement" -> HoldForm[a \[CircleTimes] b == 
         b \[CircleTimes] a], "Proof" -> <||>|>, {"CriticalPairLemma", 1} -> 
    ...
    {"SubstitutionLemma", 3} -> 
     ...
     <|"Statement" -> HoldForm[(OverBar[b] \[CircleTimes] a) \[CircleTimes] 
          b == a], "Proof" -> <|"Input" -> {"SubstitutionLemma", 4}, 
    ...
    {"Conclusion", 1} -> <|"Statement" -> HoldForm[a \[CircleTimes] b == 
         a \[CircleTimes] b], "Proof" -> <|"Input" -> {"Hypothesis", 1}, 
        "Construct" -> {"CriticalPairLemma", 11}, "Position" -> {}, 
        "Rule" -> (a_) \[CircleTimes] (b_) -> b \[CircleTimes] a, 
        "Orientation" -> 1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2, "OutputExpression" -> HoldForm[a \[CircleTimes] b == 
