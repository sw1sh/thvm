ProofObject["EquationalLogic", Inactive[Equal][
  a \[CircleTimes] (b \[CircleTimes] c), (a \[CircleTimes] b) \[CircleTimes] 
   c], {Inactive[Equal][(a_) \[CircleTimes] 
    OverBar[(b_) \[CircleTimes] 
 ...
 <|"Variables" -> {a, b, c, d, x4, x5, x6, x7, x8, x9}, "Constants" -> {}, 
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"CriticalPairLemma", 10} -> 
     ...
     <|"Statement" -> HoldForm[d == a \[CircleTimes] 
          OverBar[(OverBar[OverBar[OverBar[c \[CircleTimes] 
                 d]]] \[CircleTimes] (x4 \[CircleTimes] 
              OverBar[x4])) \[CircleTimes] (c \[CircleTimes] a)]], 
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 1}, 
        "Construct" -> {"CriticalPairLemma", 10}, "Position" -> {2, 1, 1, 1}, 
        "Rule" -> ((a_) \[CircleTimes] OverBar[a_]) \[CircleTimes] (b_) -> 
          OverBar[OverBar[b]], "Orientation" -> -1, "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 2, "OutputExpression" -> 
         HoldForm[d == a \[CircleTimes] OverBar[
             (OverBar[OverBar[OverBar[c \[CircleTimes] d]]] \[CircleTimes] (
                x4 \[CircleTimes] OverBar[x4])) \[CircleTimes] 
              (c \[CircleTimes] a)]], "Source" -> "cpl"|>|>, 
    {"SubstitutionLemma", 5} -> 
     <|"Statement" -> HoldForm[
    ...
    {"SubstitutionLemma", 8} -> 
     <|"Statement" -> HoldForm[x5 == c \[CircleTimes] 
          (OverBar[OverBar[OverBar[OverBar[OverBar[c]]]]] \[CircleTimes] 
           x5)], "Proof" -> <|"Input" -> {"SubstitutionLemma", 7}, 
    ...
    {"SubstitutionLemma", 12} -> 
     <|"Statement" -> HoldForm[x5 == c \[CircleTimes] 
       ...
       <|"Input" -> {"SubstitutionLemma", 8}, "Construct" -> 
         {"SubstitutionLemma", 11}, "Position" -> {2, 1, 1}, 
    ...
    {"SubstitutionLemma", 13} -> 
     ...
     <|"Statement" -> HoldForm[b \[CircleTimes] (c \[CircleTimes] 
       ...
       <|"Construct" -> {"SubstitutionLemma", 9}, "Orientation" -> -1, 
        ...
        "Position" -> {2, 1, 1}|>|>, {"SubstitutionLemma", 15} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] (c \[CircleTimes] 
           OverBar[c]) == b], "Proof" -> 
     ...
     <|"Statement" -> HoldForm[OverBar[OverBar[a]] == a], 
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 18}, 
        ...
        "Side" -> 2, "OutputExpression" -> HoldForm[OverBar[OverBar[a]] == 
           a], "Source" -> "cpl"|>|>, {"SubstitutionLemma", 17} -> 
     <|"Statement" -> HoldForm[OverBar[c \[CircleTimes] a] \[CircleTimes] 
          c == OverBar[a]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 5}, 
        "Construct" -> {"SubstitutionLemma", 16}, "Position" -> {1, 1}, 
        "Rule" -> OverBar[OverBar[a_]] -> a, "Orientation" -> 1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1, 
        "OutputExpression" -> HoldForm[
          OverBar[c \[CircleTimes] a] \[CircleTimes] c == OverBar[a]], 
        "Source" -> "cpl"|>|>, {"CriticalPairLemma", 24} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[b] \[CircleTimes] a] == 
         OverBar[a] \[CircleTimes] b], "Proof" -> 
       <|"Construct" -> {"SubstitutionLemma", 17}, "Orientation" -> 1, 
        "Rule" -> OverBar[(a_) \[CircleTimes] (b_)] \[CircleTimes] (a_) -> 
    ...
    {"CriticalPairLemma", 25} -> 
     <|"Statement" -> HoldForm[OverBar[c] \[CircleTimes] 
          (OverBar[b] \[CircleTimes] a) == OverBar[
      ...
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 24}, 
        "Orientation" -> 1, "Rule" -> OverBar[OverBar[a_] \[CircleTimes] 
            (b_)] -> OverBar[b] \[CircleTimes] a, "Side" -> 1, 
        ...
        "MatchingRule" -> OverBar[OverBar[a_] \[CircleTimes] (b_)] -> 
          OverBar[b] \[CircleTimes] a, "MatchingSide" -> 1, 
        "Position" -> {1, 1}|>|>, {"SubstitutionLemma", 18} -> 
     <|"Statement" -> HoldForm[d == a \[CircleTimes] 
          (OverBar[c \[CircleTimes] a] \[CircleTimes] 
           (OverBar[x4 \[CircleTimes] OverBar[x4]] \[CircleTimes] 
            OverBar[OverBar[c \[CircleTimes] d]]))], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 4}, 
        "Construct" -> {"CriticalPairLemma", 25}, "Position" -> {2}, 
        "Rule" -> OverBar[(OverBar[a_] \[CircleTimes] (b_)) \[CircleTimes] 
            (c_)] -> OverBar[c] \[CircleTimes] (OverBar[b] \[CircleTimes] a), 
        "Orientation" -> -1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2, "OutputExpression" -> HoldForm[
          d == a \[CircleTimes] (OverBar[c \[CircleTimes] a] \[CircleTimes] 
             (OverBar[x4 \[CircleTimes] OverBar[x4]] \[CircleTimes] 
              OverBar[OverBar[c \[CircleTimes] d]]))], "Source" -> "cpl"|>|>, 
    {"SubstitutionLemma", 19} -> 
     <|"Statement" -> HoldForm[d == a \[CircleTimes] 
          (OverBar[c \[CircleTimes] a] \[CircleTimes] (c \[CircleTimes] d))], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 18}, 
        "Construct" -> {"SubstitutionLemma", 10}, "Position" -> {2, 2}, 
        "Rule" -> OverBar[(a_) \[CircleTimes] OverBar[a_]] \[CircleTimes] 
           OverBar[OverBar[b_]] -> b, "Orientation" -> -1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[d == a \[CircleTimes] 
            (OverBar[c \[CircleTimes] a] \[CircleTimes] (c \[CircleTimes] 
              d))], "Source" -> "cpl"|>|>, {"CriticalPairLemma", 26} -> 
    ...
    {"SubstitutionLemma", 20} -> 
     <|"Statement" -> HoldForm[b \[CircleTimes] c == a \[CircleTimes] 
      ...
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 27}, 
        "Construct" -> {"CriticalPairLemma", 24}, "Position" -> {2, 1}, 
        "Rule" -> OverBar[OverBar[a_] \[CircleTimes] (b_)] -> 
          OverBar[b] \[CircleTimes] a, "Orientation" -> 1, 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2, 
        "OutputExpression" -> HoldForm[b \[CircleTimes] c == 
           a \[CircleTimes] ((OverBar[a] \[CircleTimes] b) \[CircleTimes] 
             c)], "Source" -> "cpl"|>|>, {"CriticalPairLemma", 28} -> 
     <|"Statement" -> HoldForm[(OverBar[OverBar[a]] \[CircleTimes] 
           b) \[CircleTimes] c == a \[CircleTimes] (b \[CircleTimes] c)], 
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 20}, 
        "Orientation" -> -1, "Rule" -> (a_) \[CircleTimes] 
           ((OverBar[a_] \[CircleTimes] (b_)) \[CircleTimes] (c_)) -> 
          b \[CircleTimes] c, "Side" -> 1, "Subpattern" -> 
