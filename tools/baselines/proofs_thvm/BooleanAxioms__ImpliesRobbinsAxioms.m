{ProofObject["EquationalLogic", Inactive[Equal][a \[CirclePlus] b, 
 ...
 ProofObject["EquationalLogic", Inactive[Equal][
   OverBar[OverBar[a \[CirclePlus] b] \[CirclePlus] 
     OverBar[a \[CirclePlus] OverBar[b]]], a], 
  {Inactive[Equal][(a_) \[CircleTimes] (b_), (b_) \[CircleTimes] (a_)], 
   Inactive[Equal][(a_) \[CircleTimes] ((b_) \[CirclePlus] (c_)), 
    (a_) \[CircleTimes] (b_) \[CirclePlus] (a_) \[CircleTimes] (c_)], 
   Inactive[Equal][(a_) \[CirclePlus] (b_) \[CircleTimes] OverBar[b_], a_], 
  ...
  <|"Variables" -> {a, b, c, x3}, "Constants" -> {}, 
   "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
     ...
     {"Axiom", 4} -> <|"Statement" -> HoldForm[
      ...
      <|"Statement" -> HoldForm[
         OverBar[OverBar[a \[CirclePlus] b] \[CirclePlus] 
            OverBar[a \[CirclePlus] OverBar[b]]] == a], "Proof" -> <||>|>, 
     {"CriticalPairLemma", 1} -> <|"Statement" -> 
        HoldForm[b == a \[CircleTimes] OverBar[a] \[CirclePlus] b], 
       "Proof" -> <|"Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
         "Rule" -> (a_) \[CirclePlus] (b_) \[CircleTimes] OverBar[b_] -> a, 
     ...
     {"SubstitutionLemma", 70} -> <|"Statement" -> 
      ...
      <|"Statement" -> HoldForm[
       ...
       "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Construct" -> 
         ...
         "OutputExpression" -> HoldForm[OverBar[OverBar[a \[CirclePlus] 
                b]] \[CircleTimes] (a \[CirclePlus] OverBar[b]) == a], 
      ...
      <|"Statement" -> HoldForm[(a \[CirclePlus] b) \[CircleTimes] 
       ...
       "Proof" -> <|"Input" -> {"SubstitutionLemma", 71}, 
         ...
         "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1, 
         "OutputExpression" -> HoldForm[(a \[CirclePlus] b) \[CircleTimes] 
             (a \[CirclePlus] OverBar[b]) == a], "Source" -> "cpl"|>|>, 
     {"SubstitutionLemma", 73} -> <|"Statement" -> 
        HoldForm[a \[CirclePlus] b \[CircleTimes] OverBar[b] == a], 
       "Proof" -> <|"Input" -> {"SubstitutionLemma", 72}, 
         ...
         "Orientation" -> -1, "ConstructSide" -> 1, "InputOrientation" -> 1, 
         "Side" -> 1, "OutputExpression" -> HoldForm[
           a \[CirclePlus] b \[CircleTimes] OverBar[b] == a], 
         "Source" -> "cpl"|>|>, {"Conclusion", 1} -> 
      <|"Statement" -> HoldForm[a == a], "Proof" -> 
        <|"Input" -> {"SubstitutionLemma", 73}, "Construct" -> {"Axiom", 3}, 
