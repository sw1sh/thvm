   ...
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
     ...
     <|"Statement" -> HoldForm[
        ((\[FormalD] \[CenterDot] \[FormalE]) \[CenterDot] 
           ...
           ((\[FormalD] \[CenterDot] \[FormalF]) \[CenterDot] \[FormalD])) == 
    ...
    {"SubstitutionLemma", 45} -> 
     <|"Statement" -> HoldForm[
        ((\[FormalD] \[CenterDot] \[FormalE]) \[CenterDot] 
           \[FormalF]) \[CenterDot] (\[FormalD] \[CenterDot] \[FormalF]) == 
     ...
     <|"Statement" -> HoldForm[
        ((\[FormalE] \[CenterDot] \[FormalD]) \[CenterDot] 
           \[FormalF]) \[CenterDot] (\[FormalD] \[CenterDot] \[FormalF]) == 
         \[FormalF]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 45}, 
        "Position" -> {1, 1}, "Construct" -> {"SubstitutionLemma", 44}, 
        "Orientation" -> 1, "Rule" -> (\[FormalA]_) \[CenterDot] 
        ...
        "OutputExpression" -> HoldForm[
          ((\[FormalE] \[CenterDot] \[FormalD]) \[CenterDot] 
             \[FormalF]) \[CenterDot] (\[FormalD] \[CenterDot] \[FormalF]) == 
           \[FormalF]], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1|>|>, {"SubstitutionLemma", 47} -> 
     <|"Statement" -> HoldForm[(\[FormalF] \[CenterDot] 
           (\[FormalE] \[CenterDot] \[FormalD])) \[CenterDot] 
          (\[FormalD] \[CenterDot] \[FormalF]) == \[FormalF]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 46}, "Position" -> {1}, 
        ...
        "Rule" -> (\[FormalA]_) \[CenterDot] (\[FormalB]_) -> 
         ...
         HoldForm[(\[FormalF] \[CenterDot] (\[FormalE] \[CenterDot] 
             ...
             \[FormalF]) == \[FormalF]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
