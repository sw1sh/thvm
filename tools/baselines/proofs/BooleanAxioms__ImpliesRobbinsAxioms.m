ProofObject["EquationalLogic", {ForAll[{\[FormalA], \[FormalB]}, 
  ...
  ForAll[{\[FormalA], \[FormalB]}, 
   OverBar[OverBar[\[FormalA] \[CirclePlus] \[FormalB]] \[CirclePlus] 
      OverBar[\[FormalA] \[CirclePlus] OverBar[\[FormalB]]]] == \[FormalA]]}, 
   ...
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
    ...
    {"Hypothesis", 3} -> <|"Statement" -> 
       HoldForm[OverBar[OverBar[\[FormalT] \[CirclePlus] 
             \[FormalU]] \[CirclePlus] OverBar[\[FormalT] \[CirclePlus] 
             OverBar[\[FormalU]]]] == \[FormalT]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
     ...
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
      ...
      "Proof" -> <|"Construct" -> {"Axiom", 4}, "Orientation" -> -1, 
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) \[CirclePlus] 
          ...
          \[FormalA] \[CircleTimes] (\[FormalB] \[CirclePlus] \[FormalC]), 
        "Side" -> 1, "Subpattern" -> (\[FormalA]_) \[CircleTimes] 
          (\[FormalB]_), "MatchingConstruct" -> {"CriticalPairLemma", 10}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
     ...
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
      ...
      "Proof" -> <|"Construct" -> {"Axiom", 4}, "Orientation" -> -1, 
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) \[CirclePlus] 
          ...
          \[FormalA] \[CircleTimes] (\[FormalB] \[CirclePlus] \[FormalC]), 
        "Side" -> 1, "Subpattern" -> (\[FormalA]_) \[CircleTimes] 
          (\[FormalC]_), "MatchingConstruct" -> {"CriticalPairLemma", 10}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (\[FormalA]_) \[CircleTimes] (\[FormalA]_) -> \[FormalA], 
    ...
    {"SubstitutionLemma", 5} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CirclePlus] 
          (\[FormalA] \[CirclePlus] \[FormalB]) == \[FormalA] \[CirclePlus] 
          \[FormalB]], "Proof" -> <|"Input" -> {"CriticalPairLemma", 19}, 
     ...
     <|"Statement" -> HoldForm[\[FormalA] \[CirclePlus] \[FormalB] == 
      ...
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 21}, 
        ...
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (\[FormalA]_) \[CircleTimes] (\[FormalB]_) <-> 
          (\[FormalB]_) \[CircleTimes] (\[FormalA]_), "MatchingSide" -> 1, 
        "Position" -> {2, 2}|>|>, {"CriticalPairLemma", 37} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CirclePlus] \[FormalB] == 
    ...
    {"SubstitutionLemma", 34} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[\[FormalU] \[CirclePlus] 
             \[FormalT]] \[CirclePlus] OverBar[\[FormalT] \[CirclePlus] 
             OverBar[\[FormalU]]]] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 3}, "Position" -> {1, 1, 1}, 
        "Construct" -> {"Axiom", 6}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[OverBar[OverBar[\[FormalU] \[CirclePlus] 
               \[FormalT]] \[CirclePlus] OverBar[\[FormalT] \[CirclePlus] 
    ...
    {"SubstitutionLemma", 35} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[\[FormalT] \[CirclePlus] 
            ...
            \[FormalU] \[CirclePlus] \[FormalT]]] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 34}, "Position" -> {1}, 
        "Construct" -> {"Axiom", 6}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[OverBar[OverBar[\[FormalT] \[CirclePlus] OverBar[
                \[FormalU]]] \[CirclePlus] OverBar[\[FormalU] \[CirclePlus] 
               \[FormalT]]] == \[FormalT]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 36} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[(\[FormalU] \[CirclePlus] 
             \[FormalT]) \[CircleTimes] (\[FormalT] \[CirclePlus] 
             OverBar[\[FormalU]])]] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 35}, "Position" -> {1}, 
        "Construct" -> {"CriticalPairLemma", 52}, "Orientation" -> 1, 
        "Rule" -> OverBar[\[FormalA]_] \[CirclePlus] OverBar[\[FormalB]_] -> 
          OverBar[\[FormalB] \[CircleTimes] \[FormalA]], 
        "OutputExpression" -> HoldForm[
          OverBar[OverBar[(\[FormalU] \[CirclePlus] 
               \[FormalT]) \[CircleTimes] (\[FormalT] \[CirclePlus] OverBar[
                \[FormalU]])]] == \[FormalT]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 37} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[\[FormalT] \[CirclePlus] 
            \[FormalU] \[CircleTimes] OverBar[\[FormalU]]]] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 36}, 
        "Position" -> {1, 1}, "Construct" -> {"CriticalPairLemma", 6}, 
        "Orientation" -> -1, "Rule" -> ((\[FormalA]_) \[CirclePlus] 
            (\[FormalB]_)) \[CircleTimes] ((\[FormalB]_) \[CirclePlus] 
    ...
    {"SubstitutionLemma", 38} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[\[FormalT] \[CirclePlus] 
            OverBar[\[FormalU]] \[CircleTimes] \[FormalU]]] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 37}, 
        ...
        "OutputExpression" -> HoldForm[
          OverBar[OverBar[\[FormalT] \[CirclePlus] OverBar[
                \[FormalU]] \[CircleTimes] \[FormalU]]] == \[FormalT]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 39} -> 
     <|"Statement" -> HoldForm[
        OverBar[OverBar[OverBar[\[FormalU]] \[CircleTimes] 
             \[FormalU] \[CirclePlus] \[FormalT]]] == \[FormalT]], 
    ...
    {"SubstitutionLemma", 40} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalU]] \[CircleTimes] 
           \[FormalU] \[CirclePlus] \[FormalT] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 39}, "Position" -> {}, 
        "Construct" -> {"SubstitutionLemma", 4}, "Orientation" -> -1, 
        "Rule" -> OverBar[OverBar[\[FormalA]_]] -> \[FormalA], 
        "OutputExpression" -> HoldForm[OverBar[\[FormalU]] \[CircleTimes] 
             \[FormalU] \[CirclePlus] \[FormalT] == \[FormalT]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 41} -> 
     <|"Statement" -> HoldForm[\[FormalU] \[CircleTimes] 
           OverBar[\[FormalU]] \[CirclePlus] \[FormalT] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 40}, "Position" -> {1}, 
        "Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) -> 
          \[FormalB] \[CircleTimes] \[FormalA], "OutputExpression" -> 
         HoldForm[\[FormalU] \[CircleTimes] OverBar[\[FormalU]] \[CirclePlus] 
            \[FormalT] == \[FormalT]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"Conclusion", 3} -> <|"Statement" -> HoldForm[\[FormalT] == \[FormalT]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 41}, "Position" -> {}, 
        ...
        "OutputExpression" -> HoldForm[\[FormalT] == \[FormalT]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>}|>]
