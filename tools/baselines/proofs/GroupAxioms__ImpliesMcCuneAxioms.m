  ...
  "Constants" -> {}, "Proof" -> 
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
    ...
    {"Hypothesis", 1} -> <|"Statement" -> 
       HoldForm[\[FormalF] \[CircleTimes] OverBar[\[FormalG] \[CircleTimes] 
            (((\[FormalH] \[CircleTimes] OverBar[\[FormalH]]) \[CircleTimes] 
              OverBar[\[FormalI] \[CircleTimes] \[FormalG]]) \[CircleTimes] 
             \[FormalF])] == \[FormalI]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
    ...
    {"SubstitutionLemma", 5} -> 
     ...
     <|"Statement" -> HoldForm[OverBar[\[FormalA] \[CircleTimes] 
       ...
       <|"Construct" -> {"SubstitutionLemma", 5}, "Orientation" -> 1, 
        ...
        "Position" -> {2, 1}|>|>, {"CriticalPairLemma", 10} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA] \[CircleTimes] 
    ...
    {"SubstitutionLemma", 6} -> 
     <|"Statement" -> HoldForm[\[FormalF] \[CircleTimes] 
          OverBar[\[FormalG] \[CircleTimes] ((\[FormalH] \[CircleTimes] 
              (OverBar[\[FormalH]] \[CircleTimes] OverBar[
                \[FormalI] \[CircleTimes] \[FormalG]])) \[CircleTimes] 
             \[FormalF])] == \[FormalI]], "Proof" -> 
       <|"Input" -> {"Hypothesis", 1}, "Position" -> {2, 1, 2, 1}, 
        ...
        "Rule" -> ((\[FormalA]_) \[CircleTimes] (\[FormalB]_)) \[CircleTimes] 
         ...
         HoldForm[\[FormalF] \[CircleTimes] OverBar[\[FormalG] \[CircleTimes] 
              ((\[FormalH] \[CircleTimes] (OverBar[\[FormalH]] \[CircleTimes] 
                 OverBar[\[FormalI] \[CircleTimes] 
                   \[FormalG]])) \[CircleTimes] \[FormalF])] == \[FormalI]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 7} -> 
     <|"Statement" -> HoldForm[\[FormalF] \[CircleTimes] 
          OverBar[\[FormalG] \[CircleTimes] ((\[FormalH] \[CircleTimes] 
              OverBar[(\[FormalI] \[CircleTimes] \[FormalG]) \[CircleTimes] 
                \[FormalH]]) \[CircleTimes] \[FormalF])] == \[FormalI]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 6}, 
        "Position" -> {2, 1, 2, 1, 2}, "Construct" -> {"CriticalPairLemma", 
          10}, "Orientation" -> -1, "Rule" -> 
         OverBar[\[FormalA]_] \[CircleTimes] OverBar[\[FormalB]_] -> 
          OverBar[\[FormalB] \[CircleTimes] \[FormalA]], 
        "OutputExpression" -> HoldForm[\[FormalF] \[CircleTimes] 
            OverBar[\[FormalG] \[CircleTimes] ((\[FormalH] \[CircleTimes] 
                OverBar[(\[FormalI] \[CircleTimes] \[FormalG]) \[CircleTimes] 
                  \[FormalH]]) \[CircleTimes] \[FormalF])] == \[FormalI]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 8} -> 
     <|"Statement" -> HoldForm[\[FormalF] \[CircleTimes] 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 7}, 
        "Position" -> {2, 1, 2, 1, 2, 1}, "Construct" -> {"Axiom", 2}, 
        "Orientation" -> -1, "Rule" -> ((\[FormalA]_) \[CircleTimes] 
            (\[FormalB]_)) \[CircleTimes] (\[FormalC]_) -> 
          \[FormalA] \[CircleTimes] (\[FormalB] \[CircleTimes] \[FormalC]), 
        "OutputExpression" -> HoldForm[\[FormalF] \[CircleTimes] 
        ...
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 9} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalG] \[CircleTimes] 
           (\[FormalH] \[CircleTimes] OverBar[\[FormalI] \[CircleTimes] 
              (\[FormalG] \[CircleTimes] \[FormalH])])] == \[FormalI]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 8}, "Position" -> {}, 
        ...
        "Rule" -> (\[FormalA]_) \[CircleTimes] OverBar[
            (\[FormalB]_) \[CircleTimes] ((\[FormalC]_) \[CircleTimes] 
              (\[FormalA]_))] -> OverBar[\[FormalB] \[CircleTimes] 
            \[FormalC]], "OutputExpression" -> HoldForm[
          OverBar[\[FormalG] \[CircleTimes] (\[FormalH] \[CircleTimes] 
              OverBar[\[FormalI] \[CircleTimes] (\[FormalG] \[CircleTimes] 
                 \[FormalH])])] == \[FormalI]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"SubstitutionLemma", 10} -> 
     <|"Statement" -> HoldForm[(\[FormalI] \[CircleTimes] 
           (\[FormalG] \[CircleTimes] \[FormalH])) \[CircleTimes] 
          OverBar[\[FormalG] \[CircleTimes] \[FormalH]] == \[FormalI]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 9}, "Position" -> {}, 
        "Construct" -> {"CriticalPairLemma", 12}, "Orientation" -> -1, 
        "Rule" -> OverBar[(\[FormalA]_) \[CircleTimes] 
            ((\[FormalB]_) \[CircleTimes] OverBar[\[FormalC]_])] -> 
          \[FormalC] \[CircleTimes] OverBar[\[FormalA] \[CircleTimes] 
             \[FormalB]], "OutputExpression" -> 
         HoldForm[(\[FormalI] \[CircleTimes] (\[FormalG] \[CircleTimes] 
              \[FormalH])) \[CircleTimes] OverBar[\[FormalG] \[CircleTimes] 
              \[FormalH]] == \[FormalI]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, 
    ...
    {"SubstitutionLemma", 12} -> 
     <|"Statement" -> HoldForm[\[FormalI] \[CircleTimes] OverTilde[1] == 
         \[FormalI]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 11}, 
        "Position" -> {2}, "Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
