   ...
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
    ...
    {"Axiom", 3} -> <|"Statement" -> HoldForm[
        \[FormalA] \[CirclePlus] (\[FormalB] \[CirclePlus] \[FormalC]) == 
         (\[FormalA] \[CirclePlus] \[FormalB]) \[CirclePlus] \[FormalC]], 
      "Proof" -> <||>|>, {"Hypothesis", 1} -> 
     <|"Statement" -> HoldForm[(\[FormalJ] \[CirclePlus] 
           \[FormalK]) \[CirclePlus] \[FormalL] == \[FormalJ] \[CirclePlus] 
          (\[FormalK] \[CirclePlus] \[FormalL])], "Proof" -> <||>|>, 
    {"Hypothesis", 2} -> <|"Statement" -> 
       HoldForm[\[FormalH] \[CirclePlus] \[FormalI] == 
         \[FormalI] \[CirclePlus] \[FormalH]], "Proof" -> <||>|>, 
    {"Hypothesis", 3} -> <|"Statement" -> 
       HoldForm[OverBar[OverBar[\[FormalM] \[CirclePlus] 
             \[FormalN]] \[CirclePlus] OverBar[\[FormalM] \[CirclePlus] 
             OverBar[\[FormalN]]]] == \[FormalM]], "Proof" -> <||>|>, 
    {"Conclusion", 1} -> <|"Statement" -> 
       HoldForm[\[FormalI] \[CirclePlus] \[FormalH] == 
         \[FormalI] \[CirclePlus] \[FormalH]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 2}, "Position" -> {}, 
        ...
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
         ...
         HoldForm[\[FormalI] \[CirclePlus] \[FormalH] == 
           \[FormalI] \[CirclePlus] \[FormalH]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, {"CriticalPairLemma", 1} -> 
     ...
     <|"Statement" -> HoldForm[\[FormalA] == 
      ...
      "Proof" -> <|"Construct" -> {"Axiom", 1}, "Orientation" -> -1, 
        ...
        "MatchingRule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) <-> 
          (\[FormalB]_) \[CirclePlus] (\[FormalA]_), "MatchingSide" -> 1, 
        "Position" -> {2, 1}|>|>, {"Conclusion", 2} -> 
     <|"Statement" -> HoldForm[\[FormalJ] \[CirclePlus] 
          (\[FormalK] \[CirclePlus] \[FormalL]) == \[FormalJ] \[CirclePlus] 
          (\[FormalK] \[CirclePlus] \[FormalL])], 
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Position" -> {}, 
        ...
        "Rule" -> ((\[FormalA]_) \[CirclePlus] (\[FormalB]_)) \[CirclePlus] 
         ...
         HoldForm[\[FormalJ] \[CirclePlus] (\[FormalK] \[CirclePlus] 
             \[FormalL]) == \[FormalJ] \[CirclePlus] 
            (\[FormalK] \[CirclePlus] \[FormalL])], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>, {"CriticalPairLemma", 3} -> 
    ...
    {"CriticalPairLemma", 14} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] == 
        ...
        "Position" -> {1, 1, 1}|>|>, {"SubstitutionLemma", 7} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] == 
         OverBar[\[FormalA] \[CirclePlus] \[FormalB]] \[CirclePlus] 
          OverBar[\[FormalA] \[CirclePlus] OverBar[\[FormalB]]]], 
      "Proof" -> <|"Input" -> {"CriticalPairLemma", 14}, 
        "Position" -> {2, 1, 1}, "Construct" -> {"CriticalPairLemma", 13}, 
        ...
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2|>|>, 
    {"SubstitutionLemma", 8} -> 
     <|"Statement" -> HoldForm[OverBar[OverBar[\[FormalM]]] == \[FormalM]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 3}, "Position" -> {1}, 
        "Construct" -> {"SubstitutionLemma", 7}, "Orientation" -> -1, 
        "Rule" -> OverBar[(\[FormalA]_) \[CirclePlus] 
             (\[FormalB]_)] \[CirclePlus] OverBar[(\[FormalA]_) \[CirclePlus] 
             OverBar[\[FormalB]_]] -> OverBar[\[FormalA]], 
        "OutputExpression" -> HoldForm[OverBar[OverBar[\[FormalM]]] == 
           \[FormalM]], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1|>|>, {"Conclusion", 3} -> 
     <|"Statement" -> HoldForm[\[FormalM] == \[FormalM]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 8}, "Position" -> {}, 
        ...
        "OutputExpression" -> HoldForm[\[FormalM] == \[FormalM]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>}|>]
