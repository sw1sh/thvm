 ...
 <|"Variables" -> {\[FormalA], \[FormalB], \[FormalC], \[FormalD], 
  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Hypothesis", 1} -> <|"Statement" -> 
       HoldForm[\[FormalD] \[CircleTimes] \[FormalE] == 
         \[FormalE] \[CircleTimes] \[FormalD]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
    ...
    {"Conclusion", 1} -> <|"Statement" -> 
       HoldForm[\[FormalE] \[CircleTimes] \[FormalD] == 
         \[FormalE] \[CircleTimes] \[FormalD]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Position" -> {}, 
        ...
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) -> 
         ...
         HoldForm[\[FormalE] \[CircleTimes] \[FormalD] == 
           \[FormalE] \[CircleTimes] \[FormalD]], "ConstructSide" -> 1, 
        "InputOrientation" -> 1, "Side" -> 1|>|>}|>]
