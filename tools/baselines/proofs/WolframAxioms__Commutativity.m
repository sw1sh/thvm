ProofObject["EquationalLogic", {ForAll[{\[FormalA], \[FormalB]}, 
   ...
   ((\[FormalA] \[CenterDot] \[FormalB]) \[CenterDot] 
    ...
    \[FormalD], \[FormalE], \[FormalAlpha], \[FormalBeta]}, 
  "Constants" -> {}, "Proof" -> 
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
      ...
      "Proof" -> <||>|>, {"Hypothesis", 1} -> 
     <|"Statement" -> HoldForm[\[FormalD] \[CenterDot] \[FormalE] == 
         \[FormalE] \[CenterDot] \[FormalD]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
    ...
    {"SubstitutionLemma", 43} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CenterDot] 
          ((\[FormalB] \[CenterDot] \[FormalC]) \[CenterDot] 
           (\[FormalC] \[CenterDot] \[FormalA])) == \[FormalC] \[CenterDot] 
          \[FormalA]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 42}, 
    ...
    {"SubstitutionLemma", 44} -> 
     ...
     <|"Statement" -> HoldForm[(\[FormalA] \[CenterDot] 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 44}, "Position" -> {2}, 
        "Construct" -> {"CriticalPairLemma", 51}, "Orientation" -> 1, 
        "Rule" -> ((\[FormalA]_) \[CenterDot] (\[FormalB]_)) \[CenterDot] 
           (\[FormalA]_) -> \[FormalA] \[CenterDot] (\[FormalA] \[CenterDot] 
            \[FormalB]), "OutputExpression" -> HoldForm[
    ...
    {"Conclusion", 1} -> <|"Statement" -> 
       HoldForm[\[FormalE] \[CenterDot] \[FormalD] == \[FormalE] \[CenterDot] 
          \[FormalD]], "Proof" -> <|"Input" -> {"Hypothesis", 1}, 
        "Position" -> {}, "Construct" -> {"SubstitutionLemma", 47}, 
        "Orientation" -> 1, "Rule" -> (\[FormalA]_) \[CenterDot] 
           (\[FormalB]_) -> \[FormalB] \[CenterDot] \[FormalA], 
        "OutputExpression" -> HoldForm[\[FormalE] \[CenterDot] \[FormalD] == 
