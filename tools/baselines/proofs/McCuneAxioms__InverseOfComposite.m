ProofObject["EquationalLogic", {ForAll[{\[FormalA], \[FormalB]}, 
 ...
 <|"Variables" -> {\[FormalA], \[FormalB], \[FormalC], \[FormalD], 
    \[FormalE], \[FormalF], \[FormalAlpha], \[FormalBeta]}, 
  "Constants" -> {}, "Proof" -> 
   {{"Axiom", 1} -> <|"Statement" -> HoldForm[\[FormalA] == 
     ...
     <|"Statement" -> HoldForm[OverBar[\[FormalF]] \[CircleTimes] 
          OverBar[\[FormalE]] == OverBar[\[FormalE] \[CircleTimes] 
    ...
    {"SubstitutionLemma", 12} -> 
     ...
     <|"Statement" -> HoldForm[\[FormalA] == (\[FormalA] \[CircleTimes] 
      ...
      "Proof" -> <|"Construct" -> {"SubstitutionLemma", 8}, 
        ...
        "Position" -> {1, 2}|>|>, {"CriticalPairLemma", 36} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA] \[CircleTimes] 
    ...
    {"Conclusion", 1} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalE] \[CircleTimes] \[FormalF]] == 
         OverBar[\[FormalE] \[CircleTimes] \[FormalF]]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Position" -> {}, 
        ...
        "OutputExpression" -> HoldForm[OverBar[\[FormalE] \[CircleTimes] 
             \[FormalF]] == OverBar[\[FormalE] \[CircleTimes] \[FormalF]]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>}|>]
