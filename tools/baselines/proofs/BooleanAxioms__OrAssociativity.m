  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Axiom", 6} -> <|"Statement" -> HoldForm[
     ...
     <|"Statement" -> HoldForm[(\[FormalO] \[CirclePlus] 
           \[FormalP]) \[CirclePlus] \[FormalQ] == \[FormalO] \[CirclePlus] 
    ...
    {"SubstitutionLemma", 13} -> 
     <|"Statement" -> HoldForm[(\[FormalP] \[CirclePlus] 
      ...
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Position" -> {1}, 
        ...
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[(\[FormalP] \[CirclePlus] \[FormalO]) \[CirclePlus] 
            \[FormalQ] == \[FormalO] \[CirclePlus] (\[FormalP] \[CirclePlus] 
             \[FormalQ])], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1|>|>, {"SubstitutionLemma", 14} -> 
     <|"Statement" -> HoldForm[(\[FormalP] \[CirclePlus] 
           \[FormalO]) \[CirclePlus] \[FormalQ] == \[FormalO] \[CirclePlus] 
          (\[FormalQ] \[CirclePlus] \[FormalP])], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 13}, "Position" -> {2}, 
        "Construct" -> {"Axiom", 6}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[(\[FormalP] \[CirclePlus] \[FormalO]) \[CirclePlus] 
            \[FormalQ] == \[FormalO] \[CirclePlus] (\[FormalQ] \[CirclePlus] 
             \[FormalP])], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 2|>|>, {"SubstitutionLemma", 15} -> 
     <|"Statement" -> HoldForm[(\[FormalP] \[CirclePlus] 
           \[FormalO]) \[CirclePlus] \[FormalQ] == 
         (\[FormalQ] \[CirclePlus] \[FormalP]) \[CirclePlus] \[FormalO]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 14}, "Position" -> {}, 
        "Construct" -> {"Axiom", 6}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[(\[FormalP] \[CirclePlus] \[FormalO]) \[CirclePlus] 
            \[FormalQ] == (\[FormalQ] \[CirclePlus] \[FormalP]) \[CirclePlus] 
      ...
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 15}, "Position" -> {}, 
        ...
        "Rule" -> ((\[FormalA]_) \[CirclePlus] (\[FormalB]_)) \[CirclePlus] 
           (\[FormalC]_) -> (\[FormalC] \[CirclePlus] 
            \[FormalA]) \[CirclePlus] \[FormalB], "OutputExpression" -> 
         HoldForm[(\[FormalQ] \[CirclePlus] \[FormalP]) \[CirclePlus] 
            \[FormalO] == (\[FormalQ] \[CirclePlus] \[FormalP]) \[CirclePlus] 
            \[FormalO]], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1|>|>}|>]
