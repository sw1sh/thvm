ProofObject["EquationalLogic", 
 {ForAll[\[FormalA], OverBar[\[FormalA]] \[CircleTimes] \[FormalA] == 
    OverTilde[1]]}, {ForAll[{\[FormalA], \[FormalB], \[FormalC]}, 
  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
    ...
    {"Hypothesis", 1} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalF]] \[CircleTimes] \[FormalF] == 
         OverTilde[1]], "Proof" -> <||>|>, {"CriticalPairLemma", 1} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
    ...
    {"SubstitutionLemma", 3} -> 
     ...
     <|"Statement" -> HoldForm[OverTilde[1] == OverTilde[1]], 
      "Proof" -> <|"Input" -> {"Hypothesis", 1}, "Position" -> {}, 
        ...
        "Rule" -> OverBar[\[FormalA]_] \[CircleTimes] (\[FormalA]_) -> 
          OverTilde[1], "OutputExpression" -> HoldForm[OverTilde[1] == 
           OverTilde[1]], "ConstructSide" -> 1, "InputOrientation" -> 1, 
        "Side" -> 1|>|>}|>]
