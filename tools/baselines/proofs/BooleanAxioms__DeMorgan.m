ProofObject["EquationalLogic", {ForAll[{\[FormalA], \[FormalB]}, 
  ...
  ForAll[{\[FormalA], \[FormalB]}, 
   OverBar[\[FormalA] \[CircleTimes] \[FormalB]] == 
    OverBar[\[FormalA]] \[CirclePlus] OverBar[\[FormalB]]]}, 
 ...
 <|"Variables" -> {\[FormalA], \[FormalB], \[FormalC], \[FormalD], 
  ...
  "Proof" -> {{"Axiom", 1} -> <|"Statement" -> 
       HoldForm[\[FormalA] == \[FormalA] \[CircleTimes] 
          (\[FormalB] \[CirclePlus] OverBar[\[FormalB]])], "Proof" -> <||>|>, 
    ...
    {"Axiom", 5} -> <|"Statement" -> HoldForm[
        \[FormalA] \[CirclePlus] \[FormalB] == \[FormalB] \[CirclePlus] 
          \[FormalA]], "Proof" -> <||>|>, {"Axiom", 6} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CirclePlus] 
          \[FormalB] \[CircleTimes] \[FormalC] == 
         (\[FormalA] \[CirclePlus] \[FormalB]) \[CircleTimes] 
          (\[FormalA] \[CirclePlus] \[FormalC])], "Proof" -> <||>|>, 
    {"Hypothesis", 1} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalO]] \[CircleTimes] OverBar[\[FormalP]] == 
         OverBar[\[FormalO] \[CirclePlus] \[FormalP]]], "Proof" -> <||>|>, 
    {"Hypothesis", 2} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalQ]] \[CirclePlus] OverBar[\[FormalR]] == 
         OverBar[\[FormalQ] \[CircleTimes] \[FormalR]]], "Proof" -> <||>|>, 
    {"CriticalPairLemma", 1} -> 
     <|"Statement" -> HoldForm[(\[FormalA] \[CirclePlus] 
    ...
    {"SubstitutionLemma", 8} -> 
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
          ...
          \[FormalB]], "Proof" -> <|"Input" -> {"SubstitutionLemma", 7}, 
        "Position" -> {1}, "Construct" -> {"SubstitutionLemma", 3}, 
     ...
     <|"Statement" -> HoldForm[\[FormalA] \[CircleTimes] 
      ...
      "Proof" -> <|"Construct" -> {"Axiom", 4}, "Orientation" -> -1, 
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) \[CirclePlus] 
          ...
          \[FormalA] \[CircleTimes] (\[FormalB] \[CirclePlus] \[FormalC]), 
        "Side" -> 1, "Subpattern" -> (\[FormalA]_) \[CircleTimes] 
          (\[FormalC]_), "MatchingConstruct" -> {"SubstitutionLemma", 8}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         (\[FormalA]_) \[CircleTimes] ((\[FormalA]_) \[CircleTimes] 
            (\[FormalB]_)) -> \[FormalA] \[CircleTimes] \[FormalB], 
        "MatchingSide" -> 1, "Position" -> {2}|>|>, 
    ...
    {"CriticalPairLemma", 21} -> 
     ...
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] \[CircleTimes] 
          ...
          OverBar[\[FormalA]]], "Proof" -> 
       <|"Input" -> {"CriticalPairLemma", 22}, "Position" -> {}, 
     ...
     <|"Statement" -> HoldForm[(\[FormalA] \[CircleTimes] 
      ...
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 29}, 
        ...
        "Side" -> 1, "Subpattern" -> (\[FormalC]_) \[CirclePlus] 
          (\[FormalA]_), "MatchingConstruct" -> {"CriticalPairLemma", 21}, 
        "MatchingOrientation" -> -1, "MatchingRule" -> 
         (\[FormalA]_) \[CirclePlus] (\[FormalA]_) \[CircleTimes] 
            (\[FormalB]_) -> \[FormalA], "MatchingSide" -> 1, 
        "Position" -> {2, 2}|>|>, {"CriticalPairLemma", 32} -> 
     <|"Statement" -> HoldForm[(\[FormalA] \[CircleTimes] 
           \[FormalB]) \[CircleTimes] \[FormalC] == 
         (\[FormalA] \[CircleTimes] \[FormalB]) \[CircleTimes] 
          (\[FormalB] \[CircleTimes] \[FormalC])], 
      "Proof" -> <|"Construct" -> {"CriticalPairLemma", 30}, 
        ...
        "Side" -> 1, "Subpattern" -> (\[FormalB]_) \[CirclePlus] 
          (\[FormalA]_), "MatchingConstruct" -> {"SubstitutionLemma", 11}, 
        "MatchingOrientation" -> -1, "MatchingRule" -> 
         (\[FormalA]_) \[CirclePlus] (\[FormalB]_) \[CircleTimes] 
            (\[FormalA]_) -> \[FormalA], "MatchingSide" -> 1, 
    ...
    {"CriticalPairLemma", 37} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] \[CirclePlus] 
         ...
         OverBar[\[FormalA]] \[CirclePlus] \[FormalA] \[CircleTimes] 
           \[FormalB]], "Proof" -> <|"Construct" -> {"CriticalPairLemma", 
          12}, "Orientation" -> -1, "Rule" -> 
         OverBar[\[FormalA]_] \[CirclePlus] (\[FormalA]_) \[CircleTimes] 
            (\[FormalB]_) -> OverBar[\[FormalA]] \[CirclePlus] \[FormalB], 
        "Side" -> 1, "Subpattern" -> (\[FormalA]_) \[CircleTimes] 
          (\[FormalB]_), "MatchingConstruct" -> {"SubstitutionLemma", 22}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
    ...
    {"CriticalPairLemma", 39} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] \[CircleTimes] 
          \[FormalB] == OverBar[OverBar[\[FormalB]] \[CirclePlus] 
           \[FormalA]]], "Proof" -> <|"Construct" -> {"SubstitutionLemma", 
          3}, "Orientation" -> -1, "Rule" -> OverBar[OverBar[\[FormalA]_]] -> 
          \[FormalA], "Side" -> 1, "Subpattern" -> OverBar[\[FormalA]_], 
        "MatchingConstruct" -> {"SubstitutionLemma", 24}, 
        "MatchingOrientation" -> 1, "MatchingRule" -> 
         OverBar[OverBar[\[FormalA]_] \[CircleTimes] (\[FormalB]_)] -> 
          OverBar[\[FormalB]] \[CirclePlus] \[FormalA], "MatchingSide" -> 1, 
        "Position" -> {1}|>|>, {"SubstitutionLemma", 25} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalQ]] \[CirclePlus] 
          OverBar[\[FormalR]] == OverBar[\[FormalR] \[CircleTimes] 
           \[FormalQ]]], "Proof" -> <|"Input" -> {"Hypothesis", 2}, 
        "Position" -> {1}, "Construct" -> {"Axiom", 3}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CircleTimes] (\[FormalB]_) -> 
          \[FormalB] \[CircleTimes] \[FormalA], "OutputExpression" -> 
         HoldForm[OverBar[\[FormalQ]] \[CirclePlus] OverBar[\[FormalR]] == 
           OverBar[\[FormalR] \[CircleTimes] \[FormalQ]]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2|>|>, 
    {"Conclusion", 1} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalR] \[CircleTimes] \[FormalQ]] == 
         OverBar[\[FormalR] \[CircleTimes] \[FormalQ]]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 25}, "Position" -> {}, 
        ...
        "Rule" -> OverBar[\[FormalA]_] \[CirclePlus] OverBar[\[FormalB]_] -> 
          OverBar[\[FormalB] \[CircleTimes] \[FormalA]], 
        "OutputExpression" -> HoldForm[OverBar[\[FormalR] \[CircleTimes] 
             \[FormalQ]] == OverBar[\[FormalR] \[CircleTimes] \[FormalQ]]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>, 
    {"CriticalPairLemma", 40} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalA]] \[CircleTimes] 
          OverBar[\[FormalB]] == OverBar[\[FormalB] \[CirclePlus] 
           \[FormalA]]], "Proof" -> <|"Construct" -> {"CriticalPairLemma", 
          39}, "Orientation" -> -1, "Rule" -> 
         OverBar[OverBar[\[FormalA]_] \[CirclePlus] (\[FormalB]_)] -> 
          OverBar[\[FormalB]] \[CircleTimes] \[FormalA], "Side" -> 1, 
        "Subpattern" -> OverBar[\[FormalA]_], "MatchingConstruct" -> 
         {"SubstitutionLemma", 3}, "MatchingOrientation" -> -1, 
        "MatchingRule" -> OverBar[OverBar[\[FormalA]_]] -> \[FormalA], 
        "MatchingSide" -> 1, "Position" -> {1, 1}|>|>, 
    {"SubstitutionLemma", 26} -> 
     <|"Statement" -> HoldForm[OverBar[\[FormalO]] \[CircleTimes] 
          OverBar[\[FormalP]] == OverBar[\[FormalP] \[CirclePlus] 
           \[FormalO]]], "Proof" -> <|"Input" -> {"Hypothesis", 1}, 
        "Position" -> {1}, "Construct" -> {"Axiom", 5}, "Orientation" -> 1, 
        "Rule" -> (\[FormalA]_) \[CirclePlus] (\[FormalB]_) -> 
          \[FormalB] \[CirclePlus] \[FormalA], "OutputExpression" -> 
         HoldForm[OverBar[\[FormalO]] \[CircleTimes] OverBar[\[FormalP]] == 
           OverBar[\[FormalP] \[CirclePlus] \[FormalO]]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 2|>|>, 
    {"Conclusion", 2} -> <|"Statement" -> 
       HoldForm[OverBar[\[FormalP] \[CirclePlus] \[FormalO]] == 
         OverBar[\[FormalP] \[CirclePlus] \[FormalO]]], 
      "Proof" -> <|"Input" -> {"SubstitutionLemma", 26}, "Position" -> {}, 
        ...
        "Rule" -> OverBar[\[FormalA]_] \[CircleTimes] OverBar[\[FormalB]_] -> 
          OverBar[\[FormalB] \[CirclePlus] \[FormalA]], 
        "OutputExpression" -> HoldForm[OverBar[\[FormalP] \[CirclePlus] 
             \[FormalO]] == OverBar[\[FormalP] \[CirclePlus] \[FormalO]]], 
        "ConstructSide" -> 1, "InputOrientation" -> 1, "Side" -> 1|>|>}|>]
