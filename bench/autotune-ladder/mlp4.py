"""Level 11 -- 4-layer MLP forward (784 -> 128 -> 64 -> 32 -> 10) on tinygrad.

Run:
    cd /Users/swish/src/tinygrad
    PYTHONPATH=. DEV=METAL python3 /Users/swish/src/thvm/bench/autotune-ladder/mlp4.py
"""
import os, sys, time
...
class MLP4:
  def __init__(self):
    ...
    self.l3_mid = nn.Linear(64, 32)
    self.l4 = nn.Linear(32, 10)

  def __call__(self, x):
    return self.l4(self.l3_mid(self.l2_mid(self.l1(x).relu()).relu()).relu()).softmax()
