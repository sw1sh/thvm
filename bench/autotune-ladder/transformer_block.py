"""Level 19 -- single GPT-2-style transformer block on tinygrad.

Self-attention + residual + LayerNorm + FFN (Linear -> GELU
-> Linear) + residual + LayerNorm.  Same config as Level 18.

Run:
    cd /Users/swish/src/tinygrad
    PYTHONPATH=. DEV=METAL python3 /Users/swish/src/thvm/bench/autotune-ladder/transformer_block.py
"""
import math
import os, sys, time
