"""Level 6 -- LeNet forward (1x28x28 -> 10) on tinygrad.

Mirrors bench/autotune-ladder/lenet.wls so kernel_count
comparison is apples-to-apples.

Run:
    cd /Users/swish/src/tinygrad
    PYTHONPATH=. DEV=METAL python3 /Users/swish/src/thvm/bench/autotune-ladder/lenet.py
"""
import os, sys, time
