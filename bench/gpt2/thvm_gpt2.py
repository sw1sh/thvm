#!/usr/bin/env python3
# tinygrad's examples/gpt2.py, run against thvm's Python bridge.
# The ONLY changes vs tinygrad/examples/gpt2.py are the imports:
#   from tinygrad import ...          -> from thvm import ...
#   from tinygrad.uop.ops import UOp  -> from thvm.uop.ops import UOp
#   from tinygrad.helpers import ...  -> from thvm.helpers import ...
#   from tinygrad.llm.gguf import ... -> from thvm.llm.gguf import ...
#   from tinygrad.nn import ...       -> from thvm.nn import ...
#   from tinygrad.nn.state import ... -> from thvm.nn.state import ...
#   from extra.bench_log import ...   -> local bench_log shim (tinygrad-repo extra,
#                                        not part of the tinygrad frontend surface).
# Everything below the imports is byte-identical to tinygrad's gpt2.py.
import os, argparse, contextlib
from typing import Optional, Union
with contextlib.suppress(ImportError): import tiktoken
from thvm import Tensor, TinyJit, Device, GlobalCounters, Variable, dtypes
from thvm.uop.ops import UOp
from thvm.helpers import Timing, DEBUG, JIT, getenv, fetch, colored, trange
from thvm.llm.gguf import gguf_load
from thvm.nn import Embedding, Linear, LayerNorm
from thvm.nn.state import torch_load, load_state_dict, get_state_dict
from bench_log import BenchEvent, WallTimeEvent
