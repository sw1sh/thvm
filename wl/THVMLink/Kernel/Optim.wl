...
GeneralUtilities`SetUsage[TAdam, "TAdam[loss$, params$, m$, v$, b1pow$, b2pow$, opts$] applies one graph-resident Adam step minimising the scalar TTerm loss$ over the TTerm tensor handles params$, returning params$ for chaining.
