...
| Subsystem            | Surface symbols                                                                                                                                                                                                                                |
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Term calculus        | <code>[TLam]()</code>, <code>[TApp]()</code>, <code>[TSup]()</code>, <code>[TDup]()</code>, <code>[TEra]()</code>, <code>[TVarFor]()</code>, <code>[TFreshLabel]()</code>                                                                          |
| Reduction            | <code>[TWnf]()</code>, <code>[TNf]()</code>, <code>[TCnf]()</code>, <code>[TStep]()</code>, <code>[TInteract]()</code>, <code>[TRedexes]()</code>, <code>[TCollapse]()</code>                                                                      |
| Tensors              | <code>[TTensor]()</code>, <code>[TTensorCreate]()</code>, <code>[TTensorData]()</code>, <code>[TTensorShape]()</code>, <code>[TTensorDType]()</code>, <code>[TRequiresGrad]()</code>, <code>[TSet]()</code>                                        |
| UOp graph            | <code>[TUOpAdd]()</code>, <code>[TUOpMul]()</code>, <code>[TUOpReshape]()</code>, <code>[TUOpReduce]()</code>, <code>[TUOpCast]()</code>, <code>[TUOpGrad]()</code>, <code>[TMaterialize]()</code>, <code>[TRealize]()</code>                      |
| Autodiff             | <code>[TGrad]()</code>, <code>[TGradOf]()</code>, <code>[TRequiresGradQ]()</code>, <code>[TClearGrad]()</code>                                                                                                                                    |
| Neural nets          | <code>[TLinear]()</code>, <code>[TConv2D]()</code>, <code>[TAttention]()</code>, <code>[TBatchNorm]()</code>, <code>[TLayerNorm]()</code>, <code>[TSoftmax]()</code>, <code>[TFromNet]()</code>, <code>[TGlorot]()</code>                          |
| Kernels              | <code>[TKernel]()</code>, <code>[TKernelSource]()</code>, <code>[TKernelOpts]()</code>, <code>[TOpt]()</code>, <code>[TKernelApplyOpt]()</code>, <code>[TKernelAutotune]()</code>, <code>[TKernelAutotuneUnique]()</code>                          |
| Memory and profiling | <code>[TMemoryPlan]()</code>, <code>[TMemoryPlanReport]()</code>, <code>[TProfile]()</code>, <code>[THotCounters]()</code>, <code>[TBench]()</code>, <code>[TBenchReport]()</code>                                                                |
| Visualization        | <code>[THeapGraph]()</code>, <code>[THeapDiagram]()</code>, <code>[TScheduleGraph]()</code>, <code>[TMemoryPlanGantt]()</code>                                                                                                                    |
| Snapshots            | <code>[TContextSnapshot]()</code>, <code>[TInitialize]()</code>, <code>[TContext]()</code>, <code>[TContextNew]()</code>, <code>[TInContext]()</code>                                                                                              |
| ATP (`THVMLink`ATP`) | <code>[TFindProof]()</code>, <code>[TRelevantAxioms]()</code>, <code>[TAtpSchedule]()</code>, <code>[TAtpDescribeMethod]()</code>, <code>[TATP]()</code>                                                                                          |
