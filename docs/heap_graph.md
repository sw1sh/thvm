...
on GitHub; a couple of the examples also embed a live PNG produced
by [docs/images/generate.wls](images/generate.wls) so you can compare
against the WL renderer's actual output.
...
Live `THeapGraph[app]` (regenerated by
[docs/images/generate.wls](images/generate.wls)):

![identity applied to ERA](images/heap_graph_2_id_app_era.png)
...
Live `THeapGraph[dp0]` (regenerated by
[docs/images/generate.wls](images/generate.wls)):

![dup of sup setup](images/heap_graph_4_dup_sup_setup.png)
